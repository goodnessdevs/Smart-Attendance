...
//     return (
//       <div className="flex items-center justify-center h-screen gap-x-2">
//         <p className="animate-spin w-6 h-6">
//           <Loader2 />
//         </p>
//         <p className="text-lg font-semibold">Loading dashboard...</p>
//       </div>
  ...
  return (
    <div className="px-4 md:px-8 mb-12">
      ...
      <div className="mt-12 mb-10 flex flex-col items-center">
        ...
        >
          <div className="w-14 h-14 flex items-center justify-center rounded-full bg-cyan-600 text-white dark:bg-cyan-300 dark:text-black shadow-md">
