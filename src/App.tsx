...
// ---------------- Lazy-loaded Lecturer Pages ----------------
const PublishAttendance = lazy(() => import("./pages/lecturer-pages/PublishAttendance"));
const Calendar = lazy(() => import("./pages/lecturer-pages/Calendar"));
const LecturerInbox = lazy(() => import("./pages/lecturer-pages/Inbox"));
const LecturerAuth = lazy(() => import("./pages/lecturer-pages/PasswordAuth"));
const AttendanceDashboard = lazy(() => import("./pages/lecturer-pages/Dashboard"));
const LecturerAccount = lazy(() => import("./pages/lecturer-pages/Account"));
const LecturerLogin = lazy(() => import("./pages/lecturer-pages/Login"));
const StudentSupportPage = lazy(() => import("./pages/lecturer-pages/StudentSupportPage"));
const LecturerOnboarding = lazy(() => import("./pages/lecturer-pages/Onboarding"));
const LecturerCourseRegistration = lazy(() => import("./pages/lecturer-pages/LecturerCourseRegistration"));
const AttendanceList = lazy(() => import("./pages/lecturer-pages/AttendanceList"));

// ---------------- Lazy-loaded Admin Pages ----------------
const AdminAccount = lazy(() => import("./pages/admin/Account"));
const AdminDashboard = lazy(() => import("./pages/admin/Dashboard"));
const CreatedCourses = lazy(() => import("./pages/admin/CreatedCourses"));
const AdminLogin = lazy(() => import("./pages/admin/Login"));
const AdminCalendarPage = lazy(() => import("./pages/admin/Calendar"));
const EditCoursesPage = lazy(() => import("./pages/admin/EditCourses"));
